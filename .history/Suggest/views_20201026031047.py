...
def suggest(request):
    ...
    if(score>29 and score<=40):
        ...
        for i in company_sym:
            fullname_list.append(getattr(fullname.filter(symbol=i)[0],'full_name'))
...
{'rank':'5 ','weight':'2.291049 ','company':fullname_list[19] }]
        ...
        company_sym = ['ACN','MLM','USB','BLL','CMI','DG','TEL','CMCSA','SRE','OKE','DFS','HBAN','CAG','COP','WMT','SNPS','NWSA','HIG','CMS','KLAC']
        fullname_list = []
        for i in company_sym:
            fullname_list.append(getattr(fullname.filter(symbol=i)[0],'full_name'))
...
{'rank':'8' ,'weight': ' 2.045686' ,'company':fullname_list[19]}]
        ...
        company_sym = ['HBAN','NAVI','VMC','CMG','ADM','LEN','SRCL','CAG','AVY','K','FDX','LMT','TRV','LKQ','MPC','URI','PCG','HRB','ZTS','DIS']
        fullname_list = []
        for i in company_sym:
            fullname_list.append(getattr(fullname.filter(symbol=i)[0],'full_name'))
        companies = [{'rank':'17',  'weight':'14.743481', 'company':fullname_list[0]},
{'rank':' 5','weight':  '10.209154','company':fullname_list[1] },
{'rank':'13','weight':  ' 6.338018','company':fullname_list[2] },
{'rank':' 6','weight':  ' 6.076180','company':fullname_list[3] },
{'rank':' 2','weight':  ' 5.921661','company':fullname_list[4] },
{'rank':' 9','weight':  ' 5.649694','company':fullname_list[5] },
{'rank':'14','weight':  ' 5.629875','company':fullname_list[6] },
{'rank':'22','weight':  ' 5.403317','company':fullname_list[7] },
{'rank':' 4','weight':  ' 4.679148','company':fullname_list[8] },
{'rank':'16','weight':  ' 4.317574','company':fullname_list[9] },
{'rank':'12','weight':  ' 3.658119','company':fullname_list[10]},
{'rank':'23','weight':  ' 3.627833','company':fullname_list[11]},
{'rank':'11','weight':  ' 3.526781','company':fullname_list[12]},
{'rank':'10','weight':  ' 2.964144','company':fullname_list[13]},
{'rank':'19','weight':  ' 2.660496','company':fullname_list[14]},
{'rank':' 7','weight':  ' 2.299644','company':fullname_list[15]},
{'rank':'15','weight':  ' 2.216550','company':fullname_list[16]},
{'rank':'8 ','weight':  '2.101344 ','company':fullname_list[17]},
{'rank':'1 ','weight':  '1.909679 ','company':fullname_list[18]},
{'rank':'20','weight':  ' 1.830676','company':fullname_list[19]}]
