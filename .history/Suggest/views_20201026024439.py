...
def suggest(request):
    ...
    if(score>29 and score<=40):
        companies = [{'rank':'20','weight':'12.006750','company':fullname(symbol='CMS')},
...
{'rank':'13','weight':  '2.371006'   ,'company':'KLAC'}]
        ...
        companies = [{'rank':'6' , 'weight':'20.378874' ,'company': getattr(fullname.filter(symbol='SO')[0],'risk_score')},    
