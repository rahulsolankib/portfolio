...
{'rank':'20','weight':  ' 1.830676','company':'DIS'}]
    ...
    full_name = []
    for ele in comp1:
        symbol.append(ele['company'])
        full_name.append(fullName(ele['company']))
        break

    data = {'symbol':symbol,'full_name':full_name}

    form = StoreName(data)
    StoreName.objects.create(symbol=symbol[0], full_name=full_name[0])
