...
def job():
    ...
    label = ['msfl','aapl','goog','amzn','wba', 'noc', 'ba', 'lmt', 'mcd', 'intc', 'nav', 'ibm', 'txn', 'ma', 'ge', 'axp', 'pep', 'ko', 'jnj', 'tm', 'hmc', 'msbhy', 'sne', 'xom', 'cvx', 'vlo', 'f', 'bac']
    today = date.today() 
