...
class QForm(forms.Form):
    ...
    ques5 = forms.TypedChoiceField(label='Imagine that your investment presents a negative return. What would you do? ',choices=income_status, coerce=int, initial=3)
