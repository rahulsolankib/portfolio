...
class QForm(forms.Form):
    ...
    ques5 = forms.TypedChoiceField(label='Imagine that your investment presents a negative return. What would you do? ',choices=loss_tolerance, coerce=int, initial=1)
    ques6 = forms.TypedChoiceField(label='What is the percentage of your total wealth that you would like to invest? ',choices=percentage_invest, coerce=int, initial=4)


class QueForm(forms.ModelForm):
    class Meta:
        model = Que
        fields = ['ques1','ques2','ques4','ques5']
