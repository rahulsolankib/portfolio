...
class QForm(forms.Form):
    ...
    ques6 = forms.TypedChoiceField(label='What is the percentage of your total wealth that you would like to invest? ',choices=income_status, coerce=int, initial=3)
