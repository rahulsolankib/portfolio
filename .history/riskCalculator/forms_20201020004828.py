...
class QForm(forms.Form):
    ...
    ques4 = forms.TypedChoiceField(label='How will you describe your expected future income over the next 5 years? ',choices=experience_group, coerce=int, initial=1)
