...
class QForm(forms.Form):
    ...
    ques6 = forms.TypedChoiceField(label='What is the percentage of your total wealth that you would like to invest? ',choices=percentage_invest, coerce=int, initial=1)
